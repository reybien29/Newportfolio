    ...
    public function get(): array
    {
        ...
        return [
            ...
            'projects' => [
                ...
                [
                    'name' => 'Konek Contact Management System',
                    'summary' => 'A Laravel-based contact management system built to organize contacts, streamline updates, and keep communication records easy to manage.',
                    'role' => 'Backend and product developer',
                    'stack' => ['Laravel', 'PHP', 'Contact Management', 'MySQL'],
                    'href' => '#contact',
                    'liveUrl' => null,
                    'repoHref' => $githubProfileUrl,
                ],
